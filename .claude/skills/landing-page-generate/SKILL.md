...
description: Generate 5 landing page variants for InfiniteStories using a collaborative agent team.
...
Load these agent definitions from this skill's supporting files to understand each role:

| Agent | Definition | Responsibility |
|-------|------------|----------------|
| Manager | [agents/manager.md](agents/manager.md) | Orchestration & synthesis |
| Copywriter | [agents/copywriter.md](agents/copywriter.md) | Headlines, CTAs, copy |
| Storyteller | [agents/storyteller.md](agents/storyteller.md) | Narratives, emotions |
| Marketer | [agents/marketer.md](agents/marketer.md) | Conversion, positioning |
| SEO Expert | [agents/seo-expert.md](agents/seo-expert.md) | Keywords, meta, schema |
...
### Phase 1: Initialize
1. Read all agent definition files listed above (in the `agents/` directory of this skill)
...
- prompt: "You are the Copywriter Agent. [Include full copywriter skill content].
...
- subagent_type: "general-purpose"
- prompt: "You are the Storyteller Agent. [Include full storyteller skill content].
...
- subagent_type: "general-purpose"
- prompt: "You are the Marketer Agent. [Include full marketer skill content].
...
- subagent_type: "general-purpose"
- prompt: "You are the SEO Expert Agent. [Include full seo-expert skill content].
...
Begin by reading all agent definition files from the `agents/` directory, then launch the 4 specialist agents in parallel using the Task tool. After receiving their outputs, synthesize into final landing pages.
