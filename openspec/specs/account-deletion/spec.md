...
Define the account deletion flow to comply with Apple App Store guideline 5.1.1(v), ensuring users can permanently delete their account and all associated data from both the server and the device.
