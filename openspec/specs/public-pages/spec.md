...
Define the public-facing website pages (landing, privacy, terms, support) served by the Next.js backend, including locale support, COPPA compliance, and App Store metadata requirements.
